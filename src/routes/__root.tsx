...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Track expenses, net worth, investments, and budgets with AI insights." },
      { property: "og:title", content: "Vault — Personal Finance OS" },
      { name: "twitter:title", content: "Vault — Personal Finance OS" },
      { property: "og:description", content: "Track expenses, net worth, investments, and budgets with AI insights." },
      { name: "twitter:description", content: "Track expenses, net worth, investments, and budgets with AI insights." },
